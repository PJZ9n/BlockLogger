...
namespace PJZ9n\BlockLogger\Task;
...
class CheckUpdateTask extends AsyncTask
{
    ...
    /** @var string URI */
    private const UPDATE_HOST = "https://api.github.com/repos/pjz9n/blocklogger/releases/latest";
    ...
    public function __construct(BaseLang $lang, string $currentVersion, Logger $logger)
    {
        $this->lang = $lang;
        ...
        $logger->info($lang->translateString("update.check.host", [self::UPDATE_HOST]));
